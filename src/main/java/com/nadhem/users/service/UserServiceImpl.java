...
import com.nadhem.users.exceptions.EmailAlreadyExistsException;
import com.nadhem.users.exceptions.ExpiredTokenException;
...
public class UserServiceImpl  implements UserService{
	...
	public String  generateCode() {
	    ...
	    String verificationCode = String.format("%06d", random.nextInt(900000));
	...
	@Override
	public Boolean isUserEnabledbled(String username) {
